...
COMPOSE_PROJECT_NAME="${COMPOSE_PROJECT_NAME:-ayder_data_pipeline_recovery}"
PG_SERVICE="${PG_SERVICE:-postgres}"
PG_USER="${PG_USER:-ayder}"
PG_DB="${PG_DB:-data_pipeline_recovery}"

AYDER_BASE="${AYDER_BASE:-http://127.0.0.1:1133}"
TOKEN="${TOKEN:-dev}"
AUTH_HEADER="Authorization: Bearer ${TOKEN}"
TOPIC="${TOPIC:-data_downloads}"
GROUP="${GROUP:-data_download_worker}"
